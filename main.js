        ...
        fps() {
            ...
            this.r1.question("Enter the location of the database file (e.g., C:\\WutheringWavesj3oFh\\Wuthering Waves Game\\Client\\Saved\\LocalStorage\\LocalStorage.db): ", (dbPath) => {
                ...
                db.serialize(() => {
                    ...
                    let query = "SELECT value FROM LocalStorage WHERE key = 'GameQualitySetting';";
                    ...
                    db.get(query, (error, result) => {
                        ...
                        if (originalJson == null) {
                            console.log("Not found! Please make sure you have the correct path to the database file.");
                            return;
                        }
